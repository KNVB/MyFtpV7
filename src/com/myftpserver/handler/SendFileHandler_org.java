 ...
 */
@Sharable
public class SendFileHandler_org extends SimpleChannelInboundHandler<ByteBuf> implements ChannelHandler,ChannelFutureListener 
{
	 ...
	 */
	public SendFileHandler_org(FtpSessionHandler fs)
	{
		this.fs=fs;
