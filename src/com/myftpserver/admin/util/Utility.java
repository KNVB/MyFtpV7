...
import com.myftpserver.admin.server.listeners.CommandCompleteListener;
import com.myftpserver.admin.server.listeners.AdminServerSessionClosureListener;
...
public class Utility
{
	...
	{
		ch.writeAndFlush(Unpooled.copiedBuffer(goodByeMessage+"\r\n",CharsetUtil.UTF_8)).addListener(new AdminServerSessionClosureListener(null,ch,logger,remoteIp,goodByeMessage));
	}
	/**
	 * It sends a response message to client
	 * @param ch ftp channel
